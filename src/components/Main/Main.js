        ...
        <main className={mainCN()}>
            <Box className={mainCN('Wrapper')}>
                <Typography className={mainCN('Title')}
                            component="h2"
                >
                    Оптимизируем бизнес-процесс, предотвращаем финансовые потери увеличиваем эффективность
                </Typography>
            ...
            <Box className={mainCN('Wrapper')} id={'products'}>
                ...
                <Grid container spacing={2} columns={15}>
                    ...
                    >
                        ...
                        • 1 месяц бесплатной поддержки после внедрения изменений;
                        • 2 корректировки в хорошо работающие бизнес-процессы, в любое время в течение 6 месяцев
                    ...
                    >
                        Дополнительные возможности:
                        • 6 месяцев бесплатной поддержки после внедрения изменений
                        • 5 экстренных корректировок в любое время в течение 12 месяцев
                        • 4 корректировки в хорошо работающие бизнес-процессы, в любое время в течение 6 месяцев
